...
public class ShopService {
    ...
    public ApiResponse getShopBySellerId(Long sellerId){
        Optional<ShopEntity> shopEntity = shopRepo.findBySellerId(sellerId);
        if (shopEntity.isPresent()) {
            return new ApiResponse(shopEntity);
        }else {
    ...
    public ApiResponse createShop(ShopDto shopDto) {
        ...
        shop.setStreetHouse(shopDto.getStreetHouse());
        ShopEntity save = shopRepo.save(shop);
